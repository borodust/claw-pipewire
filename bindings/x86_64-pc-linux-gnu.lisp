...
(cffi:defcfun ("pw_context_for_each_global"
              ...
              (%pipewire::context
               (:pointer (:struct %pipewire::context)))
              (%pipewire::callback (:pointer :pointer))
              (%pipewire::data (:pointer :void)))
...
(cffi:defctype %pipewire::spa-invoke-func-t (:pointer :pointer))
...
(cffi:defctype %pipewire::destroy-t (:pointer :pointer))
